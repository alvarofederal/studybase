...
function soma(materias: Materia[], fn: (t: Topico) => number) {
  return materias.reduce((a, m) => a + m.blocos.reduce((b, bl) => b + bl.topicos.reduce((c, t) => c + fn(t), 0), 0), 0);
}
...
export default function EstudoDashboard({
  ...
  const totalTopicos    = soma(materiasComAcesso, (t) => 1);
    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="px-5 py-4 border-b border-gray-800 flex items-center justify-between shrink-0">
        ...
        <button
          ...
          className="lg:hidden w-8 h-8 flex items-center justify-center rounded-lg text-gray-500 hover:bg-gray-800"
        >
          ✕
        </button>
      </div>
    ...
    <div className="h-screen bg-gray-950 text-white flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`
          ...
          lg:relative lg:translate-x-0 lg:w-64 xl:w-72 lg:shrink-0 lg:z-auto
        `}>
          {Sidebar}
        </aside>
          ...
          <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-500 text-sm mt-1">
                {materiasComAcesso.length > 0
                  ? `Você tem ${materiasComAcesso.length} matéria${materiasComAcesso.length !== 1 ? "s" : ""} liberada${materiasComAcesso.length !== 1 ? "s" : ""}.`
                  : "Solicite acesso às matérias para começar a estudar."}
              </p>
            </div>

            {/* Stats rápidas (mobile — já que sidebar fica escondida) */}
            ...
            {materiasComAcesso.length > 0 ? (
              <section className="mb-10">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-white">Suas matérias</h2>
              ...
              <div className="text-center py-14 bg-gray-900 border border-gray-800 rounded-2xl mb-10">
            ...
            {materiasParaSolicitar.length > 0 && (
              <section>
                <div className="mb-4">
                  <h2 className="text-base sm:text-lg font-bold text-white">Solicitar acesso</h2>
                  <p className="text-gray-600 text-xs mt-0.5">
